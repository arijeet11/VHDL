...
-- co	=>  Location: PIN_B11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \d~0_combout\ = \a~combout\ $ (\cin~combout\ $ (\b~combout\))
...
\co~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \co~0_combout\ = (\a~combout\ & ((\cin~combout\) # (\b~combout\))) # (!\a~combout\ & (\cin~combout\ & \b~combout\))
